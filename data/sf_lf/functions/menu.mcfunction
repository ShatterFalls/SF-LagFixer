...
### Version Display
execute if score #Version SF.LagFixer matches 1165 run tellraw @s [{"text": "Version","color": "dark_aqua","hoverEvent": {"action": "show_text","value": "Selected Version"}},{"text": " - ","color": "gold"},{"text": "[1.16.5]","color": "green","bold": true,"hoverEvent": {"action": "show_text","value": "The Nether Update - Default"}}]
execute if score #Version SF.LagFixer matches 1201 run tellraw @s [{"text": "Version","color": "dark_aqua","hoverEvent": {"action": "show_text","value": "Selected Version"}},{"text": " - ","color": "gold"},{"text": "[1.20.1]","color": "green","bold": true,"hoverEvent": {"action": "show_text","value": "Trails & Tails"}}]
### Main
