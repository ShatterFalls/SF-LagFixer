...
tellraw @s [{"text": "[","color": "gray"},{"text": "LF","color": "green","hoverEvent": {"action": "show_text","value": [{"text": "[","color": "gray"},{"text": "SF","color": "dark_purple"},{"text": "]","color": "gray"},{"text": "LagFixer","color": "gold"}]},"clickEvent": {"action": "run_command","value": "/execute if entity @s[tag=Admin] run function sf_lagfix:menu"}},{"text": "] ","color": "gray"},{"text": "Menu---------------------------------------","color": "gold"}]
...
tellraw @s [{"text": "Force Clear","color": "dark_aqua","hoverEvent": {"action": "show_text","value": "Run Clear event"}},{"text": " - ","color": "gold"},{"text": "[->]","color": "blue","hoverEvent": {"action": "show_text","value": "Clear Now"},"clickEvent": {"action": "run_command","value": "/function sf_lagfix:clear/init"}}]
