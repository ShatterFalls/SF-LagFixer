...
execute if score #MobAI SF.LagFixer matches 1 run tellraw @s [{"text": "Mob AI [ACTIVE]","color": "dark_aqua","hoverEvent": {"action": "show_text","value": "Status of Mob AI"}},{"text": " - ","color": "gold"},{"text": "[->]","color": "blue","hoverEvent": {"action": "show_text","value": "Freeze"},"clickEvent": {"action": "run_command","value": "/function sf_lagfix:clear"}}]
execute if score #MobAI SF.LagFixer matches 0 run tellraw @s [{"text": "Mob AI [FROZEN]","color": "dark_aqua","hoverEvent": {"action": "show_text","value": "Status of Mob AI"}},{"text": " - ","color": "gold"},{"text": "[->]","color": "blue","hoverEvent": {"action": "show_text","value": "Activate"},"clickEvent": {"action": "run_command","value": "/function sf_lagfix:clear"}}]
